...
class MonthlyPortfolioEnv(gym.Env):
    ...
    def reset(
        ...
        *,
        ...
        # ---- build observation ----------------------------------------------
        obs, _dummy_mask = self.interp.interpret(
            first_month,
            self._active_universe,
            self._weights,
            self._cash,
        )
        live_mask = self._build_live_mask(first_month)
        return {"obs": obs, "action_mask": live_mask}, {}
    ...
    def step(
        ...
        live_mask = self._build_live_mask(month_t1)
        ...
        return {"obs": obs, "action_mask": live_mask}, reward, terminated, truncated, info
